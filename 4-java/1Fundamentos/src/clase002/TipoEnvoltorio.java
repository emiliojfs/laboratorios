...
public class TipoEnvoltorio {
	public static void main(String[] args) {
		...
		Boolean formadeprecado = new Boolean(false);
		Boolean formanueva = Boolean.valueOf(true);
		System.out.println("Boolean"+"\t\t\t\t:"+formadeprecado);
		System.out.println("Boolean"+"\t\t\t\t:"+formanueva);

		Character letra = new Character('a');
		Character letra_nueva = Character.valueOf('b');
		System.out.println("Character"+"\t\t\t:"+letra);
		System.out.println("Character"+"\t\t\t:"+letra_nueva);
		System.out.println("Character compareTo z"+":"+letra.compareTo('k'));
		System.out.println("Character compareTo z"+":"+letra_nueva.compareTo('k'));
